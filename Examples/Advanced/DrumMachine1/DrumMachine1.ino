...
/*********************************************************
SmartWAV2 RealDrums demo: be sure to previously load into the 
...
drum machine, channels are triggered in a constant pattern creating a rythm.
*********************************************************/
...
#define SPEED 500 //The less the delay, the faster the rythm
